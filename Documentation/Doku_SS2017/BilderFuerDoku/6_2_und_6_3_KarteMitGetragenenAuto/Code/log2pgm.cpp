...
void *checkButtonPressed(void * input) 
{
   bool* buttonWasPressed = (bool*)input;
...
*/        
   ...
   // Start thread for ending loop
   pthread_t thread;
   int rc;
   bool buttonWasPressed = false;
	
   cout << "creating thread for ending loop " << endl;
   rc = pthread_create(&thread, NULL, checkButtonPressed, (void*)&buttonWasPressed);
