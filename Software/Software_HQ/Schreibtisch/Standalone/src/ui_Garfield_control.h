...
public:
    ...
    void setupUi(QMainWindow *Garfield_control)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(560, 40, 191, 166));
        ...
        horizontalSlider->setGeometry(QRect(442, 240, 70, 16));
    ...
    void retranslateUi(QMainWindow *Garfield_control)
    {
        ...
        actionDebug->setShortcut(QApplication::translate("Garfield_control", "Ctrl+I", Q_NULLPTR));
