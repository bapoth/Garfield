...
add_interface_port export sda_pad_in export Input 1
add_interface_port export sda_pad_out export Output 1
add_interface_port export sda_pad_en export Output 1
add_interface_port export scl_pad_in export Input 1
add_interface_port export scl_pad_out export Output 1
add_interface_port export scl_pad_en export Output 1
